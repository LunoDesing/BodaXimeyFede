...
function updateTimer() {
  const targetDate = new Date("september 21, 2024 22:30:00").getTime();
...
document.getElementById('whatsappButton').addEventListener('click', function() {
  const phoneNumber = '5493521444120';  // Tu número de teléfono en formato internacional sin el símbolo '+'
...
document.getElementById('sendButton').addEventListener('click', function() {
  const recipientNumber = '5493521444120';  // Tu número de teléfono en formato internacional sin el símbolo '+'
