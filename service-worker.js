const CACHE_NAME = 'cache-v112'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v112',
    'estilos/styles.css?v112',
    'estilos/mediaQueries.css?v112',
    'javascript/script.js?v112',
